...
<head>
    ...
    <style>
        ...
        .note { background: #e8f5e9; padding: 15px; border-radius: 5px; border-left: 4px solid #4caf50; margin: 15px 0; }
        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $subscription->started_at?->timezone('Europe/Istanbul')->format('d.m.Y') ?? now()->timezone('Europe/Istanbul')->format('d.m.Y') }}</span>
                </div>
            ...
            <p>Aylık düzenli desteğiniz, özgür yazılım mücadelesi ve "özgür yazılım, özgür toplum" hedefine ulaşmak için yaptığımız dernek çalışmalarımızda büyük güç katmaktadır. Tekrardan çok teşekkür ederiz!</p>
        </div>
